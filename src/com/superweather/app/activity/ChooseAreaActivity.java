package com.superweather.app.activity;

import java.util.ArrayList;
import java.util.List;

import com.superweather.app.R;
...
import com.superweather.app.util.HttpCallbackListener;
import com.superweather.app.util.HttpUtil;
import com.superweather.app.util.Utility;
		...
		@Override
			public void onFinish(String response) {
				...
				if ("province".equals(type)) {
					...
					result = Utility.handleCitiesResponse(superWeatherDB,response, selectedProvince.getId());
				} else if ("county".equals(type)) {
					result = Utility.handleCountiesResponse(superWeatherDB,response, selectedCity.getId());
				}
				if (result) {
